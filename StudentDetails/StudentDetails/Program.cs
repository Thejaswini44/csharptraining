...
namespace StudentDetails
{
    ...
    class Program
    {
        ...
        {
            StudentDetails AryaStudentDetails = new StudentDetails(1001, "John", "c#");
            StudentDetails AnanyaStudentDetails = new StudentDetails(1002, "Jane", "ASP.NET");

           
            AryaStudentDetails.Payment(500);
            AnanyaStudentDetails.Payment(800);


            AryaStudentDetails.Print();

            Console.WriteLine("\n");


            AnanyaStudentDetails.Print();
        }
    }
